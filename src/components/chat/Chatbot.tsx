            ...
            {!isOpen && (
                <div className="fixed bottom-6 right-6 z-50 flex items-end gap-3 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    <button
                        ...
                        className="w-20 h-20 hover:scale-105 transition-transform flex items-center justify-center shrink-0 relative"
                        aria-label="Open Chat"
                    >
                        <div className="relative w-full h-full mix-blend-multiply drop-shadow-2xl">
                            <Image src="/images/new_logo.png" alt="Chat" fill className="object-cover object-center scale-[1.3]" />
                        </div>
                        <span className="absolute top-2 right-1 flex h-4 w-4 z-10">
                            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-accent opacity-75"></span>
                            <span className="relative inline-flex rounded-full h-4 w-4 bg-accent border-2 border-white shadow-sm"></span>
                        </span>
                    </button>
                </div>
            )}
